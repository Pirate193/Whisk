    ...
    >
      ...
      <View className="flex">
        <View className="flex justify-center ">
          <Text className="text-3xl dark:text-white text-center font-bold">
            Welcome Back{" "}
          </Text>
        ...
        <TouchableOpacity
          ...
          className="flex justify-center items-center bg-yellow-300 h-14 rounded-2xl"
        >
        ...
        <View className="flex justify-center items-center">
          <Text className="text-center mt-4 dark:text-white">
